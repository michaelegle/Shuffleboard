...
export_annotations = project.export_tasks(
    export_location = '../Data/stone_detection/dataset.json',
    download_all_tasks = False,
    export_type='JSON'
)

JSON_PATH = "../Data/stone_detection/dataset.json"
ORIGINAL_IMAGE_DIR = "../Training Images"
TRAIN_LABEL_OUTPUT_DIR = "../Data/stone_detection/labels/train"
VAL_LABEL_OUTPUT_DIR = "../Data/stone_detection/labels/val"
TRAIN_IMAGE_OUTPUT_DIR = "../Data/stone_detection/images/train"
VAL_IMAGE_OUTPUT_DIR = "../Data/stone_detection/images/val"
